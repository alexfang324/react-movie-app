        ...
        <div className="about-container">
          <div className="about-container-section left">
            ...
            <p>
              ...
              rating, and release date. Browse for your favourite film, add it
              to the Favourite List, and save it for the Watch Later list!
            </p>
            <p>
          ...
          <div className="about-container-section right">
            ...
            <p>
              ...
              and Amanda. We are an enthusiastic web development team that
              strives to go above and beyond what is expected from us!
            </p>
          </div>
        </div>
      </section>
